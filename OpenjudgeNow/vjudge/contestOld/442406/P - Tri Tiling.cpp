...
int main()
{
    ...
    while (cin >> n)
    {
        ...
        n = n / 2;
        Matrix nowMatrix(3);
        nowMatrix.setVal(0,0,3);
        nowMatrix.setVal(0,1,3);
        nowMatrix.setVal(0,2,1);
        Matrix muMatrix(3);
        muMatrix.setVal(0,0,1);
        muMatrix.setVal(1,0,2);
        muMatrix.setVal(2,0,2);
        muMatrix.setVal(0,1,1);
        muMatrix.setVal(1,1,3);
        muMatrix.setVal(2,1,2);
